...
> ### Note:  
> This topic is relevant to SAP Fiori elements for OData V2. For information about SAP Fiori elements for OData V4, see [Navigation to Subpages](navigation-to-subpages-5d49e31.md).
