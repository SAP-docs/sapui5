...
-   *Save as Tile*
    ...
    When the user chooses this option, the corresponding *Save as Tile* dialog is displayed. When they choose the tile, the application page opens in the same state in which the tile was created. Application developers can customize the title and the sub-title of the tile. On the list report page, a dynamic tile with a record count is created, where the applied filter is also taken into account.

-   *Share: Microsoft Teams*

    Users can collaborate with their co-workers using the *Share: Microsoft Teams* functionality. For more information, see [The Share: Microsoft Teams Functionality](the-share-microsoft-teams-functionality-8d382b1.md).
...
> ### Note:  
> -   The *Share* functionality is available for the list report page, the object page, and the subobject page.
> 
