...
> ### Note:  
> You can extend this feature to react based on filter conditions or custom configuration. For more information, see [Extending Custom View Switch](extending-custom-view-switch-be7a236.md).
