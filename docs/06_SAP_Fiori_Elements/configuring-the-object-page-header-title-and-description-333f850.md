...
[Changing Default Titles of New and Unnamed Objects](changing-default-titles-of-new-and-unnamed-objects-03bf617.md "When an end user creates new items in a list report or object page table, SAP Fiori elements provides a default title. We recommend application developers to replace it with an application-specific title.")
