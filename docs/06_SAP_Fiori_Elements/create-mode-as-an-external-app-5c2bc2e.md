...
You can enable the *Create* button to trigger navigation to an external SAP Fiori launchpad-based app which manages the creation of business objects in SAP Fiori elements for OData V4.
