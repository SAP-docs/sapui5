...
Known incompatibilities will be communicated in the [SAPUI5-TypeScript release notes](https://ui5.github.io/typescript/releasenotes.html), and in the [What's New in SAPUI5](../01_Whats-New/what-s-new-in-sapui5-99ac68a.md).
...
For more information, see [here](https://ui5.github.io/typescript/beta-statement.html#why-will-there-still-be-breaking-changes-even-after-the-type-definitions-have-left-beta-stage).

To mitigate breaking changes, you have several options; some of them are listed here: [How to mitigate breaking changes?](https://ui5.github.io/typescript/beta-statement.html#how-to-mitigate-breaking-changes-within-as-well-as-after-beta-phase)



### Combining TypeScript versions and type definition releases

See [What is the plan regarding different TypeScript versions? Which ones will each type definition release be compatible with?](https://ui5.github.io/typescript/beta-statement.html#what-is-the-plan-regarding-different-typescript-versions-which-ones-will-each-type-definition-release-be-compatible-with)
...
-   Documentation and resources: [SAPUI5 & TypeScript](https://ui5.github.io/typescript/)
