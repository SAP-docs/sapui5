...
You can also use SAP Fiori tools to extend and customize specific features of the list report page and object page. For more information, see [Configure Page Elements](https://help.sap.com/docs/SAP_FIORI_tools/17d50220bcd848aa854c9c182d65b699/047507c86afa4e96bb3d284adb9f4726.html).
...
Enable or disable the *Export Table* button in the table toolbar.
...
Enable or disable the *Copy to Clipboard* and *Paste* buttons in the table toolbar.
...
In the Page Editor, select the `Table`, and set `Copy` to `False` or `True` \(default\).
...
For vertical alignment of the whole responsive table, see [Tables](tables-f242a02.md).
...
Modify the standard list report page behavior for analytical, grid, and tree table types to not occupy the entire space available in the container
...
Change the layout of the table for better readability for a high number of columns
...
For more information about the default values for different table types, see the *Initial Data Loading Using the `threshold` Property* subsection in [Tables](tables-f242a02.md).
