...
You can enable the creation of subobjects that have a maximum of eight data fields using a dialog on the object page. You can enable this feature in the manifest setting by adding the property `createWithParameterDialog` and passing the properties of related entity set as follows:
...
With this setting, the option to create subobjects using a dialog appears on the object page.
...
[Enabling Object Creation Using the Dialog on the List Report Page](enabling-object-creation-using-the-dialog-on-the-list-report-page-2d04f60.md "You can enable the creation of objects with a dialog.")
