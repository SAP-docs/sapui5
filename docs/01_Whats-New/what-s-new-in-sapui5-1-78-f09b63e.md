...
-   You can define visual filters which have all filters as in parameters using the manifest setting `allFiltersAsInParameters`. For more information, see [Configuring the Manifest for the Analytical List Page](../06_SAP_Fiori_Elements/configuring-the-manifest-for-the-analytical-list-page-2a9df06.md).
