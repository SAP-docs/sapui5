<!-- loiob221ce09a2354512955244d7b27d5898 -->
...
> ### Note:  
> This topic is relevant to SAP Fiori elements for OData V2. For information about SAP Fiori elements for OData V4, see [Configuring Default Filter Values](configuring-default-filter-values-f27ad7b.md).
...
<a name="loiob221ce09a2354512955244d7b27d5898__section_dk1_x2n_dsb"/>
...
> 
> -   Note the special handling for the `DisplayCurrency` field, for which default values can also come from SAP Fiori launchpad \(FLP\). For more information, see the *Handling Default Values from SAP Fiori Launchpad \(FLP\)* section in [Navigation to an App \(Inbound Navigation\)](navigation-to-an-app-inbound-navigation-496b2a5.md).
> 
> -   For the analytical list page, you must set the manifest property `filterDefaultsFromSelectionVariant`: `true` to ensure the filter defaults from the `SelectionVariant` are considered.



<a name="loiob221ce09a2354512955244d7b27d5898__section_jnl_whn_dsb"/>
