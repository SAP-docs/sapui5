...
> ### Note:  
> This topic is relevant to SAP Fiori elements for OData V2. For information about SAP Fiori elements for OData V4, see [Adding Custom Input Fields to the Mass Edit Dialog](adding-custom-input-fields-to-the-mass-edit-dialog-fd26fee.md).
