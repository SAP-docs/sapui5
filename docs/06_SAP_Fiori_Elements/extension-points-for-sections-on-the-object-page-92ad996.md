...
> ### Tip:  
> Use the term `section` to add a section to the object page in the `manifest.json` file.
...
> ### Note:  
> For information about SAP Fiori elements for OData V2, see [Extension Points for Sections on the Object Page](extension-points-for-sections-on-the-object-page-1bfddc3.md).
