...
-   If you only want to describe **which** data should be displayed in a view, you can define a `SelectionVariant` containing filter criteria for the data. See [Defining Multiple Views in a List Report Page Table - Single Table Mode](defining-multiple-views-in-a-list-report-page-table-single-table-mode-0d390fe.md).

-   If you also want to describe **how** the data should be displayed \(for example, different sort orders in a table or a different visualization in a table\), you can define a `SelectionPresentationVariant`. Note that you can use this annotation only for multiple table mode and multiple table mode with charts. See [Defining Multiple Views in a List Report Page Table - Multiple Table Mode](defining-multiple-views-in-a-list-report-page-table-multiple-table-mode-37aeed7.md).
...
You can also define and configure custom views for a list report page using a controller extension. For more information, see [Extension Points for Views on the List Report Page](extension-points-for-views-on-the-list-report-page-eb37203.md).
...
-   [`setTabContentToBeRefreshedOnNextOpening`](https://ui5.sap.com/#/api/sap.fe.templates.ListReport.ExtensionAPI%23methods/setTabContentToBeRefreshedOnNextOpening)

-   [`refreshTabsCount`](https://ui5.sap.com/#/api/sap.fe.templates.ListReport.ExtensionAPI%23methods/refreshTabsCount)
...
> ### Note:  
> For information about SAP Fiori elements for OData V2, see [Multiple Views on the List Report Page](multiple-views-on-the-list-report-page-d0e6855.md).
