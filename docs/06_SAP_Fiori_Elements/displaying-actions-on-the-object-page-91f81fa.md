...
> ### Note:  
> This topic is relevant to SAP Fiori elements for OData V2. For information about SAP Fiori elements for OData V4, see [Displaying Actions on the Object Page](displaying-actions-on-the-object-page-f65e8b1.md).
...
[Adding Action Buttons to Forms in Sections](adding-action-buttons-to-forms-in-sections-14338ee.md "You can add action buttons to the forms contained in sections.")
