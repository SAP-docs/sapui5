...
> ### Note:  
> This topic is relevant to SAP Fiori elements for OData V2. For information about SAP Fiori elements for OData V4, see [Using the SecuredExecution Method](using-the-securedexecution-method-6a39150.md).
