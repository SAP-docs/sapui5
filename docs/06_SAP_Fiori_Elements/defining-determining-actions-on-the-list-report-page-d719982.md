...
Determining actions are used to trigger actions directly using the context of the table on the list report page.
...
To add a determining action to the footer of the list report page, use the annotation term `UI.LineItem` and set the `Determining` property to `true` for the complex type. This is displayed as shown below:

![](images/Determining_Action_in_List_Report_5adb885.png)

The following code sample shows an example of how to create your annotations for the determining actions on the list report page:
