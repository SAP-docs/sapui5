...
> ### Note:  
> This topic is relevant to SAP Fiori elements for OData V2. For information about SAP Fiori elements for OData V4, see [Adding a Micro Chart to a Table](adding-a-micro-chart-to-a-table-b8312a4.md).
