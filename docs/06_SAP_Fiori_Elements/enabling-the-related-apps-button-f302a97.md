...
> ### Note:  
> This topic is relevant to SAP Fiori elements for OData V2. For information about SAP Fiori elements for OData V4, see [Enabling the Related Apps Button](enabling-the-related-apps-button-8dcfe2e.md).
