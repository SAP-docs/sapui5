...
You can use analytical cards to view data in a variety of chart formats.



> ### Note:  
> This topic is relevant to SAP Fiori elements for OData V2. For information about SAP Fiori elements for OData V4, see [Analytical Cards](analytical-cards-d7b0b42.md).



The card is divided into a header and chart areas. In the header area, you can view the aggregated value of a key performance indicator \(KPI\), the trend, and percentage of change. In the chart area, you can view a graphical representation of the data.
