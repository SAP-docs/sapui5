...
> ### Note:  
> This topic is relevant to SAP Fiori elements for OData V2. For information about SAP Fiori elements for OData V4, see [Configuring Internal Navigation](configuring-internal-navigation-2c65f07.md).
