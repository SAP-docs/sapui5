...
# What's New in SAPUI5 1.140

With this release SAPUI5 is upgraded from version 1.139 to 1.140.
...
**Deprecation of Analysis Path Framework \(APF\)** 
...
Analysis Path Framework \(APF\) will be deprecated with SAPUI5 version 1.140. Analysis Path Framework \(APF\) is still officially supported, but will receive no further improvements or new features, and we do not recommend using it any longer. Consider using SAP Smart Business to cover the charts, facet filters, smart filters, and APF modeler functionalities APF used to offer. We recommend switching to SAP Smart Business as soon as possible.

<sub>Deprecated•Announcement•Recommended•1.140</sub>
...
-   You can now add tooltips to filter fields. For more information, see [Configuring Filter Bars](../06_SAP_Fiori_Elements/configuring-filter-bars-4bd7590.md).


<sub>Changed•SAP Fiori Elements•Info Only•1.140</sub>
...
We've introduced a new *Not Specified* semantic date option and a new *No Data/Range* group for dynamic range types. The new option enables filtering by unspecified periods, sending a null value in the filter query. It's available for single filters and range filters but does not apply to parameter filter fields. For more information, see the [API Reference](https://ui5.sap.com/#/api/sap.ui.comp.smartfilterbar.SmartFilterBar) and the [Sample](https://ui5.sap.com/#/entity/sap.ui.comp.smartfilterbar.SmartFilterBar/sample/sap.ui.comp.sample.smartfilterbar.UseDateRangeType).
