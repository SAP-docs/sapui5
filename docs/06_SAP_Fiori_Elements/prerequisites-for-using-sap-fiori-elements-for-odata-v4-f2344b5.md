...
# Prerequisites for Using SAP Fiori Elements for OData V4

Get to know the prerequisites for creating an application using SAP Fiori elements for OData V4.
