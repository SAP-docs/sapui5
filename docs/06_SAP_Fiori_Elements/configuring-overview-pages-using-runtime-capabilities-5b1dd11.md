...
> ### Note:  
> For information about SAP Fiori elements for OData V2, see [Configuring Overview Pages Using Runtime Capabilities](configuring-overview-pages-using-runtime-capabilities-f70023c.md).
