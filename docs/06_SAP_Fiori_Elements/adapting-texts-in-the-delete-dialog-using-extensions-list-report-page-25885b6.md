...
3.  Implement the function `'beforeDeleteExtension'` in the controller extension file of the list report page. You can adapt the delete dialog in the following ways:
    ...
    > ### Note:  
    > The property `oBeforeDeleteProperties` contains information about the items selected for deletion on the list report page.
