...
Worklist variants can now be shared, and control-level variants can be enabled in the worklist. For more information, see [Worklist Page](../06_SAP_Fiori_Elements/worklist-page-d1d588f.md).
