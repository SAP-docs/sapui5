...
# Defining Custom Actions on the Overview Page
...
> ### Note:  
> For information about SAP Fiori elements for OData V2, see [Defining Custom Actions](defining-custom-actions-7b84664.md).
