...
> ### Note:  
> For information about SAP Fiori elements for OData V2, see [Highlighting Line Items Based on Criticality](highlighting-line-items-based-on-criticality-afa38f1.md).
