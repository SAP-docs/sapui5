...
You can reduce entity sets from the application metadata using a feature toggle in SAP Fiori elements for OData V2.
...
On list report pages with multiple tabs, reducing an entity set results in the removal of tabs corresponding to that entity. Similarly, for an object page, reducing an entity set results in the removal of the corresponding section from the object page.
