...
## Enabling ALP in SAP Fiori Elements for OData V4

In SAP Fiori elements for OData V4, the ALP isn't a separate floorplan, but rather a 'flavor' of the list report. When you configure a list report template, you can choose to create the template using the 'ALP flavor'. You must then add the "views" configuration, as shown in the following sample code:
