...
-   You can now use the `MultiSelectionPlugin` in tables. For more information, see [Configuring the Selection Mode for Tables](../06_SAP_Fiori_Elements/configuring-the-selection-mode-for-tables-116b5d8.md).
...
-   In addition to the smart area micro chart and the smart bullet micro chart, you can now use the following micro charts within the object page header:
    ...
    For more information, see [Micro Chart Facet in the Object Page Header](../06_SAP_Fiori_Elements/micro-chart-facet-in-the-object-page-header-e219fd0.md).
