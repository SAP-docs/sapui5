...
-   Defining the `getCustomMessage` function in the controller file lets you customize success messages \(for no data\) and error scenarios. You can also add an icon for the success scenario. For more information, see  <?sap-ot O2O class="- topic/xref " href="b75910f6d7eb48a58d83267be2c71385.xml" text="" desc="" xtrc="xref:36" xtrf="file:/home/builder/src/dita-all/nmr1778238934258/loioa82e269bbb584cfcbdbd3ae8765d8e7f_en-US/src/content/localization/en-us/771f4d5cb01c4b6da7232ef8a841683d.xml" output-class="" outputTopicFile="file:/home/builder/tp.net.sf.dita-ot/2.3/plugins/com.elovirta.dita.markdown_1.3.0/xsl/dita2markdownImpl.xsl" ?> .
