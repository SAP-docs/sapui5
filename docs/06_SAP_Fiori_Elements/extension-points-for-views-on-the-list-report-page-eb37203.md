...
# Extension Points for Views on the List Report Page

You can use extension points to enhance views on the list report page in SAP Fiori elements for OData V4.



<a name="loioeb37203f2b884b5097c3c858107cae1f__section_nb5_455_3qb"/>

## Using Custom Views on the List Report Page

App developers can display custom content in a dedicated tab together with regular tabs defined through annotations.

> ### Restriction:  
> To use custom views on the list report page, you need to have at least 1 annotation view.
...
-   defining a controller extension for the list report page
...
## Using Filter Conditions in the Controller Extension for the List Report Page

For app developers who want a standard filtering behavior along with other annotation tabs on the list report page based on the `filterConditions` from the filter bar, SAP Fiori elements provides 2 methods that you can overwrite. The controller extension for the list report page must be registered in the manifest. To register the controller extension in the `manifest.json` file, proceed as follows:
