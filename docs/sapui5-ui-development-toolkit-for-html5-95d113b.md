...
Create apps with rich user interfaces for modern web business applications, responsive across browsers and devices, based on HTML5. \(Documentation patch 1.149.0\)
...
SAP Fiori apps are built with SAPUI5 and follow the SAP Design System guidelines to ensure consistent design and a high level of design quality. See [SAP Fiori Design Guidelines](https://www.sap.com/design-system/fiori-design-web).
