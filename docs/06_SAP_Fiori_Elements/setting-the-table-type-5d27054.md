...
> ### Note:  
> This topic is relevant to SAP Fiori elements for OData V2. For information about SAP Fiori elements for OData V4, see [Setting the Table Type](setting-the-table-type-7f844f1.md).
