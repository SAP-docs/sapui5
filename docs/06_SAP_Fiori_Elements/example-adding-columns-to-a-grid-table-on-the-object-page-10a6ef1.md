...
# Example: Adding Columns to a Grid Table on the Object Page

You can add custom columns to your object page grid table using view extensions in SAP Fiori elements for OData V2.
