...
You can configure object pages to show both text and ID for input fields of value help in the edit and create modes in SAP Fiori elements for OData V2.
