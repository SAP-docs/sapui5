...
1.  Create a view extension fragment, `customFilter.fragment.xml`, for example.
...
> ### Note:  
> For information about SAP Fiori elements for OData V2, see [Custom Filters](custom-filters-31073ca.md).
